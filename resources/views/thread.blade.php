        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <section class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            {{-- <form action="{{ route('threads.store') }}" method="POST" class="flex flex-col lg:flex-row items-start lg:items-center gap-4">
              ...
              <!-- Input Caption -->
              <div class="flex-1 w-full">
                <x-bladewind::textarea label="caption" rows="5" name="caption" required="true"/>
              </div>
      
              <!-- Submit Button -->
              <div class="flex-shrink-0">
                <x-bladewind::button onclick="action.href='{{route('threads.store')}}'">
                  Post
                </x-bladewind::button>

                {{-- <x-bladewind::modal onclick=""
                  title="Success"
                  name="no-cancel"
                  cancel_button_label="">
