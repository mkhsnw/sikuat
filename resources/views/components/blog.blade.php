			...
			<article class="bg-white shadow-lg rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl group grid md:grid-cols-2 my-8">
					...
					<div class="p-6 md:p-8 flex flex-col justify-center">
							...
							<p class="text-brand-muted leading-relaxed mb-6">
									Dive deep into the transformative world of AI, exploring cutting-edge technologies that are reshaping industries, challenging our understanding of intelligence, and creating unprecedented opportunities.
							</p>

							<a href="/detail_article" class="inline-flex items-center text-brand-accent font-semibold hover:underline group/link">
							...
							<div class="mt-6 pt-4 border-t border-gray-200 flex items-center justify-between">
									...
									<span class="text-sm text-brand-muted">3 min read</span>
							</div>
					</div>
			</article>
