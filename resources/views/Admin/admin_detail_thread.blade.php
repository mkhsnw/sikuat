      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
              <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                          ...
                          <div class="flex-1">
                              ...
                              <div class="bg-gray-50 p-4 rounded-lg mb-4">
                                  <p class="text-gray-700 leading-relaxed text-base">
                                      Just finished an amazing online course about digital marketing strategies. The insights on audience engagement and content creation are game-changing! Can't wait to implement these techniques in my next campaign. 🚀 #DigitalMarketing #OnlineLearning
                                  </p>
                              </div>
                  ...
                  <!-- Comments Section -->
                  <div class="p-6">
                      <h2 class="text-xl font-bold text-gray-800 mb-4">Comments (42)</h2>
                      ...
                      <div class="space-y-4">
                          ...
                          <div class="flex items-start space-x-4 pb-4 border-b">
                              ...
                              <div class="flex-1">
                                  <div class="flex items-center space-x-2 mb-2">
                                      ...
                                      <span class="text-gray-500 text-sm">@sarahjohn</span>
                                      <span class="text-gray-400 text-sm ml-auto">1 hour ago</span>
                                  </div>
                                  <p class="text-gray-700 leading-relaxed">
                                      Great insights! I've been looking for ways to improve my digital marketing strategy. Can you share more about the course?
                                  </p>
                          ...
                          <div class="flex items-start space-x-4 pb-4 border-b">
                              ...
                              <div class="flex-1">
                                  <div class="flex items-center space-x-2 mb-2">
                                      <span class="font-bold text-gray-900">Mike Chen</span>
                                      <span class="text-gray-500 text-sm">@mikechen</span>
                                      <span class="text-gray-400 text-sm ml-auto">45 minutes ago</span>
                                  </div>
                                  <p class="text-gray-700 leading-relaxed">
                                      Totally agree! Content is king, but engagement is the kingdom. Always looking for new strategies to connect with my audience.
                                  </p>
                                  <div class="flex items-center space-x-4 mt-2 text-gray-500 text-sm">
                                      <button class="hover:text-blue-500">Reply</button>
                                      <button class="hover:text-red-500 flex items-center space-x-1">
